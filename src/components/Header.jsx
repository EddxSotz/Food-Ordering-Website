        ...
        <div className='md:hidden'>
          ...
          {navToggle && (
            <div className='fixed inset-0 w-screen h-screenz-20' onClick={handleTapOutside}>
              <nav className='absolute top-16 right-0 bg-emerald-950/85 w-full sm:w-1/2 h-screen' ref={mobileNavRef}>           
                <ul className='flex flex-col md:flex-row gap-4 font-semibold items-center py-4 text-center'>
