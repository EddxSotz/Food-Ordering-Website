...
function HeroSection() {
  ...
  return (
    <div className={`bg-[url("/src/assets/background.jpg")] bg-cover h-screen bg-center flex flex-col justify-center items-start text-stone-50 text-center px-8 lg:px-16 relative`}>
