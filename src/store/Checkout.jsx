...
export default function Checkout () {
    ...
    return (
        <section className='container mx-auto mt-28 px-4 relative'>                                       
            {isFormVisible ? (
                <>                
                    ...
                    <div className='col-span-2'>
                        ...
                        <ul>
                            {cartCtx.cartItems.map((item) => (
                                <li key={item.id} className="grid grid-cols-3 md:grid-cols-6 gap-4 items-center border-b-1 border-gray-300 text-gray-700 shadow-md py-4 mb-2">
