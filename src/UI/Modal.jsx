    ...
    return createPortal(
        <div className="fixed inset-0 w-screen h-screen z-50">
            ...
            <div className="relative flex flex-col items-center justify-start w-full h-full text-gray-700">
                <div className="w-full h-auto text-end bg-emerald-950/90">
                    <button type="button" onClick={onClose} className="text-lg font-bold text-stone-50 border-1 border-transparent rounded-b-md hover:text-lime-600 hover:border-lime-600 active:text-red-500 active:border-red-500 p-2">X</button>
                </div>                
                {children} 
            </div>                             
            </dialog>,
