...
export default function Modal({children, openStatus, onClose}) {
    ...
    return createPortal(
        <div className="fixed inset-0 w-screen h-screen bg-gray-900/50 z-20">
            <dialog ref={modalRef} className="w-screen sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-1/4 h-screen mr-0 ml-auto mb-0 bg-stone-300/95 text-gray-700 flex flex-col" onKeyDown={handleEscapeKey} onClick={handleClickOutside}>         
